...
#ifndef DOGETOREUM_ARITH_UINT256_H
#define DOGETOREUM_ARITH_UINT256_H
...
public:
     ...
     *
     * Dogetoreum only uses this "compact" format for encoding difficulty
...
#endif // DOGETOREUM_ARITH_UINT256_H
