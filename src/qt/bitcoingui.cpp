...
void BitcoinGUI::createActions() {
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a Dogetoreum address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a Dogetoreum address").arg(strCoinJoinName));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr(" Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and dogetoreum: URIs)"));
    receiveCoinsMenuAction->setToolTip(receiveCoinsMenuAction->statusTip());

    sendAssetsMenuAction = new QAction(tr(" Send Asset"), this);
    sendAssetsMenuAction->setStatusTip(tr("Send assets to a Dogetoreum address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dogetoreum addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(
            tr("Verify messages to ensure they were signed with specified Dogetoreum addresses"));
    ...
    openAction->setStatusTip(tr("Open a dogetoreum: URI"));
    ...
    showHelpMessageAction->setStatusTip(
            tr("Show the %1 help message to get a list with possible Dogetoreum command-line options").arg(
                    PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState() {
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dogetoreum network", "", count));
    } else {
