...
/** Utility functions used by the Dogetoreum Qt UI.
 */
namespace GUIUtil {
    ...
    // Parse "dogetoreum:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load dogetoreum specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a dogetoreum specific theme is activated (light/dark).*/
