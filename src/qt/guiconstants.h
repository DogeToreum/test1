...
/* DogetoreumGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* DogetoreumGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Dogetoreum"
#define QAPP_ORG_DOMAIN "dogetoreum.com"
#define QAPP_APP_NAME_DEFAULT "Dogetoreum-Qt"
#define QAPP_APP_NAME_TESTNET "Dogetoreum-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Dogetoreum-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Dogetoreum-Qt-regtest"
