...
ModalOverlay::ModalOverlay(bool enable_wallet, QWidget *parent) :
    ...
    if (!enable_wallet) {
        ...
        ui->infoTextStrong->setText(
                tr("Dogetoreum Core is currently syncing. It will download headers at first and then blocks from peers and validate them until reaching latest block mined at chain."));
    }
}
