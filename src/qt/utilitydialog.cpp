...
HelpMessageDialog::HelpMessageDialog(interfaces::Node &node, QWidget *parent, HelpMode helpMode) :
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage: dogetoreum-qt [command-line options]                     \n";
...
All the Dogetoreum in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 DOGUM, 0.01 DOGUM, 0.1 DOGUM, 1 DOGUM and 10 DOGUM -- sort of like the paper money you use every day.</li> \
