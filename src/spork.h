...
sporkDefs = {
        ...
        MAKE_SPORK_DEF(SPORK_17_QUORUM_DKG_ENABLED, 1730521201), // On
        MAKE_SPORK_DEF(SPORK_19_CHAINLOCKS_ENABLED, 1730521201), // On
        MAKE_SPORK_DEF(SPORK_21_LOW_LLMQ_PARAMS, 4070908800ULL), // OFF
        MAKE_SPORK_DEF(SPORK_22_SPECIAL_TX_FEE, 1730521201), // On
        MAKE_SPORK_DEF(SPORK_23_QUORUM_ALL_CONNECTED, 1730521201), // On
...
public:
    ...
    void Serialize(Stream &s) const {
        ...
        // Should not reuse pubkeys from previous dogetoreumd run.
