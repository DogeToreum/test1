...
namespace llmq {
    ...
    void CDKGDebugManager::InitLocalSessionStatus(const Consensus::LLMQParams &llmqParams, const uint256 &quorumHash,
                                                  int quorumHeight) {
        LOCK(cs);
    ...
    void CDKGDebugManager::UpdateLocalSessionStatus(Consensus::LLMQType llmqType,
    ...
    void CDKGDebugManager::UpdateLocalMemberStatus(Consensus::LLMQType llmqType, size_t memberIdx,
