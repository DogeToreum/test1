...
UniValue getnewaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"getnewaddress",
               "\nReturns a new Dogetoreum address for receiving payments.\n"
               ...
               RPCResult{
                       RPCResult::Type::STR, "address", "The new dogetoreum address"
               },
               RPCExamples{
...
UniValue getrawchangeaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"getrawchangeaddress",
               "\nReturns a new Dogetoreum address, for receiving change.\n"
...
UniValue setlabel(const JSONRPCRequest &request) {
    RPCHelpMan{"setlabel",
               "\nSets the label associated with the given address.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The dogetoreum address to be associated with a label."},
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Dogetoreum address");
    }
...
UniValue sendtoaddress(const JSONRPCRequest &request) {
    ...
    RPCHelpMan{"sendtoaddress",
               ...
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Dogetoreum address to send to."},
                       ...
                       {"subtractfeefromamount", RPCArg::Type::BOOL, /* default */ "false",
                        ...
                        "                             The recipient will receive less amount of DOGUM than you enter in the amount field."},
                               ...
                               {RPCResult::Type::ARR, "", "",
                                {
                                        {RPCResult::Type::ARR, "", "",
                                         {
                                                 {RPCResult::Type::STR, "address", "The dogetoreum address"},
...
UniValue listaddressbalances(const JSONRPCRequest &request) {
    RPCHelpMan{"listaddressbalances",
               ...
               RPCResult{
                       ...
                       {
                               {RPCResult::Type::STR_AMOUNT, "amount",
                                "The dogetoreum address and the amount in " + CURRENCY_UNIT},
                       }
               },
               RPCExamples{
...
UniValue signmessage(const JSONRPCRequest &request) {
    RPCHelpMan{"signmessage",
               ...
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The Dogetoreum address to use for the private key."},
...
UniValue getreceivedbyaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"getreceivedbyaddress",
               ...
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Dogetoreum address for transactions."},
...
UniValue sendmany(const JSONRPCRequest &request) {
    RPCHelpMan{"sendmany",
               ...
               HELP_REQUIRING_PASSPHRASE,
               {
                       ...
                       {"amounts", RPCArg::Type::OBJ, RPCArg::Optional::NO, "A json object with addresses and amounts",
                        {
                                {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO,
                                 "The Dogetoreum address is the key, the numeric amount (can be string) in " +
                       ...
                       {"subtractfeefrom", RPCArg::Type::ARR, RPCArg::Optional::OMITTED_NAMED_ARG,
                        ...
                        "                           Those recipients will receive less DOGUMs than you enter in their corresponding amount field.\n"
    ...
    for (const std::string &name_: keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Dogetoreum address: ") + name_);
        }
...
UniValue addmultisigaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"addmultisigaddress",
               ...
               "Each key is a Dogetoreum address or hex-encoded public key.\n"
               ...
               "If 'label' is specified, assign address to that label.\n",
               {
                       ...
                       {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO,
                        "A json array of dogetoreum addresses or hex-encoded public keys",
                        {
                                {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED,
                                 "dogetoreum address or hex-encoded public key"},
                        },
                       },
                               ...
                               {RPCResult::Type::OBJ, "", "", Cat(Cat < std::vector < RPCResult >> (
                                                                          {
                                                                              ...
                                                                              {
                                                                                  RPCResult::Type::STR, "address", "The dogetoreum address of the transaction. Not present for\n"
                               ...
                               {RPCResult::Type::ARR, "transactions", "",
                                {
                                        {RPCResult::Type::OBJ, "", "", Cat(Cat < std::vector < RPCResult >> (
                                                                                   {
                                                                                       { RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction" },
                                                                                       { RPCResult::Type::STR, "address", "The dogetoreum address of the transaction. Not present for move transactions (category = move)." },
                                        ...
                                        {RPCResult::Type::OBJ, "", "",
                                         {
                                                 ...
                                                 {RPCResult::Type::STR, "address",
                                                  "The dogetoreum address involved in the transaction."},
...
UniValue walletpassphrase(const JSONRPCRequest &request) {
    RPCHelpMan{"walletpassphrase",
               ...
               "This is needed prior to performing transactions related to private keys such as sending dogetoreum\n"
               "\nNote:\n"
...
UniValue encryptwallet(const JSONRPCRequest &request) {
    RPCHelpMan{"encryptwallet",
               ...
               RPCExamples{
                       ...
                       "\nNow set the passphrase to use the wallet, such as for signing or sending dogetoreum\n"
...
UniValue lockunspent(const JSONRPCRequest &request) {
    RPCHelpMan{"lockunspent",
               ...
               "A locked transaction output will not be chosen by automatic coin selection, when spending dogetoreum.\n"
...
static UniValue loadwallet(const JSONRPCRequest &request) {
    RPCHelpMan{"loadwallet",
               ...
               "\nNote that all wallet command-line options used when starting dogetoreumd will be"
    ...
    RPCHelpMan{"listunspent",
               ...
               "Optionally filter to only include txouts paid to specified addresses.\n",
               {
                       ...
                       {"addresses", RPCArg::Type::ARR, /* default */ "empty array",
                        "A json array of dogetoreum addresses to filter",
                        {
                                {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "dogetoreum address"},
                        },
                       },
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY,
                                   std::string("Invalid Dogetoreum address: ") + input.get_str());
            }
    ...
    if (!options.isNull()) {
        if (options.type() == UniValue::VBOOL) {
            ...
            if (options.exists("changeAddress")) {
                ...
                if (!IsValidDestination(dest)) {
                    throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid dogetoreum address");
                }
                       ...
                       {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG,
                        "for backward compatibility: passing in a true instead of an object will result in {\"includeWatching\":true}",
                        {
                                {"changeAddress", RPCArg::Type::STR, /* default */ "pool address",
                                 "The Dogetoreum address to receive the change"},
                                ...
                                {"subtractFeeFromOutputs", RPCArg::Type::ARR, /* default */ "empty array",
                                 ...
                                 "                              Those recipients will receive less DOGUM than you enter in their corresponding amount field.\n"
...
UniValue getaddressinfo(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressinfo",
               "\nReturn information about the given dogetoreum address. Some information requires the address\n"
               "to be in the wallet.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The dogetoreum address to get the information of."},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
                               {RPCResult::Type::STR, "address", "The dogetoreum address validated."},
