...
UniValue importaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"importaddress",
               ...
               "as change, and not show up in many RPCs.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The Dogetoreum address (or hex-encoded script)"},
...

    {
        ...
        if (IsValidDestination(dest)) {
            ...
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Dogetoreum address or script");
        }
    }
    if (fRescan) {
        int64_t scanned_time = pwallet->RescanFromTime(TIMESTAMP_MIN, reserver, true /* update */);
...
UniValue dumpprivkey(const JSONRPCRequest &request) {
    RPCHelpMan{"dumpprivkey",
               ...
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The Dogetoreum address for the private key"},
               },
               RPCResult{
...
UniValue dumpwallet(const JSONRPCRequest &request) {
    RPCHelpMan{"dumpwallet",
               ...
               {
                       {"filename", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The filename with path (either absolute or relative to dogetoreumd)"},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
    ...
    // produce output
    file << strprintf("# Wallet dump created by Dogetoreum Core %s\n", CLIENT_BUILD);
    ...
    UniValue obj(UniValue::VOBJ);
    obj.pushKV("dogetoreumcoreversion", CLIENT_BUILD);
                    ...
                    result.pushKV(
                            ...
                            JSONRPCError(
                                    ...
                                    strprintf(
                                            ...
                                            "caused by pruning or data corruption (see dogetoreumd log for details) and could "
