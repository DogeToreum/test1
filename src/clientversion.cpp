 ...
 * for both dogetoreumd and dogetoreum-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Dogetoreum Core");
...
#define GIT_COMMIT_ID "900794ea94ff11023667765173295b459d32732c"
