...
bool ChronoSanityCheck() {
    ...
    // certain platforms prove to consistently deviate, at which point we will cope
    // with it by adding offsets.

    // Create a new clock from time_t(0) and make sure that it represents
    // 0 seconds from the system_clock's time_since_epoch. Then convert that back
    // to a time_t and verify that it is the same as before.
