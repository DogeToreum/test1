...
static UniValue validateaddress(const JSONRPCRequest &request) {
    RPCHelpMan{"validateaddress",
               "\nReturn information about the given dogetoreum address.\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Dogetoreum address to validate"},
               },
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
    ...
    RPCHelpMan{"verifymessage",
               "\nVerify a signed message\n",
               {
                       {"address", RPCArg::Type::STR, RPCArg::Optional::NO,
                        "The Dogetoreum address to use for the signature."},
...
UniValue getaddressutxos(const JSONRPCRequest &request) {
    RPCHelpMan{
            ...
            "\nReturns all unspent outputs for an address (requires addressindex to be enabled).\n",
            {
                ...
                {"asset", RPCArg::Type::STR, /* default */ "DOGUM", "Get UTXOs for a particular asset instead of DOGUM ('*' for all assets).",}
            },
            {
                RPCResult{"For DOGUM",
                    RPCResult::Type::ARR, "", "",
...
UniValue getaddressdeltas(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressdeltas",
               "\nReturns all changes for an address (requires addressindex to be enabled).\n",
               {
                    ...
                    {"asset", RPCArg::Type::STR, /* default */ "DOGUM", "Get all changes for a particular asset instead of DOGUM.",}
...
static UniValue getaddressbalance(const JSONRPCRequest &request) {
    RPCHelpMan{"getaddressbalance",
               "\nReturns the balance for an address(es) (requires addressindex to be enabled).\n",
        {
            ...
            {"asset", RPCArg::Type::STR, /* default */ "DOGUM", "Get balance for a particular asset instead of DOGUM. (\"*\" for all assets)"},
        },
        {
            RPCResult{"For DOGUM",
                RPCResult::Type::OBJ, "", "",
...
UniValue logging(const JSONRPCRequest &request) {
    RPCHelpMan{"logging",
               ...
               "The valid logging categories are: " + LogInstance().LogCategoriesString() + "\n"
                                                                                            ...
                                                                                            "  - \"dogetoreum\" activates all Dogetoreum-specific categories at once.\n"
...
UniValue echo(const JSONRPCRequest &request) {
    RPCHelpMan{"echo|echojson ...",
               ...
               "dogetoreum-cli and the GUI. There is no server-side difference.",
               {},
...
static const CRPCCommand commands[] =
        { //  category              name                      actor (function)         argNames
                ...
                /* Dogetoreum features */
                {"dogetoreum",    "mnsync",                 &mnsync,                 {}},
                {"dogetoreum",    "spork",                  &spork,                  {"arg0",       "value"}},
