                                ...
                                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                 {
                                         {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO,
                                          "A key-value pair. The key (string) is the Dogetoreum address, the value (float or string) is the amount in " +
                                          CURRENCY_UNIT},
                                 },
                                },
                                ...
                                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                 {
                                         ...
                                         {"future_amount", RPCArg::Type::NUM, RPCArg::Optional::NO,
                                          "Dogetoreum amount to be locked."},
                                 },
                                },
    ...
    RPCHelpMan{"decodescript",
               ...
               RPCResult{
                       RPCResult::Type::OBJ, "", "",
                       {
                               ...
                               {RPCResult::Type::ARR, "addresses", "",
                                {
                                        {RPCResult::Type::STR, "address", "Dogetoreum address"},
                                }},
