...
//! Dogetoreum Core RPC error codes
enum RPCErrorCode {
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in dogetoreumd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,  //!< Dogetoreum is not connected
