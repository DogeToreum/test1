...
#error Client version information missing: version is not defined by dogetoreum-config.h or in any other way
#endif
...
/**
 * dogetoreumd-res.rc includes this file, but it cannot cope with real c++ code.
