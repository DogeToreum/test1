#ifndef DOGETOREUM_UPDATE_HPP
#define DOGETOREUM_UPDATE_HPP
...
class VoteThreshold {
public :
    VoteThreshold(int64_t thresholdStart, int64_t thresholdMin, int64_t falloffCoeff) : thresholdStart(thresholdStart),
                                                                                        thresholdMin(thresholdMin),
                                                                                        falloffCoeff(falloffCoeff) {
        if
                (
                (thresholdMin < 0) ||
...
class Update {
public :
    Update(EUpdate updateId, std::string name, int bit, int64_t roundSize, int64_t startHeight, int64_t votingPeriod,
           int64_t votingMaxRounds, int64_t graceRounds, bool forcedUpdate,
