...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid dogetoreum address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        # send 12 DOGETOREUM to msig addr
