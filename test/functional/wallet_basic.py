...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 DOGUM from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 DOGUM in block rewards plus fees, but
        ...
        # Send 100 DOGUM with subtract fee from amount
        ...
        # Sendmany 100 DOGUM with subtract fee from amount
        ...
        # This will raise an exception for attempting to get the private key of an invalid Dogetoreum address
        assert_raises_rpc_error(-5, "Invalid Dogetoreum address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Dogetoreum address
        assert_raises_rpc_error(-5, "Invalid Dogetoreum address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid Dogetoreum address or script", self.nodes[0].importaddress, "invalid")
