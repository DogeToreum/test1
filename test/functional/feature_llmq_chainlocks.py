...
from test_framework.test_framework import DogetoreumTestFramework
...
class LLMQChainLocksTest(DogetoreumTestFramework):
    def set_test_params(self):
        self.set_dogetoreum_test_params(6, 5, fast_dip3_enforcement=True)
