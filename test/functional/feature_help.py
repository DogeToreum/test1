...
"""Verify that starting dogetoreumd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dogetoreumd with -h for help text")
        ...
        self.log.info("Start dogetoreumd with -version for version information")
        ...
        # Test that argument not in the help results is an error
        self.log.info("Start dogetoreumd with -fakearg  to make sure it does not start")
