...
Below are some notes on how to build Dogetoreum Core for Windows.

The options known to work for building Dogetoreum Core on Windows are:

* On Linux, using the [Mingw-w64](https://www.mingw-w64.org/) cross compiler tool chain. 
and is the platform used to build the Dogetoreum Core Windows release binaries.
...
way. This will install to `c:\workspace\dogetoreum`, for example:

    make install DESTDIR=/mnt/c/workspace/dogetoreum
