...
This mechanism has been integrated into Bitcore-Node-Dogetoreum which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dogetoreum/insight-api-dogetoreum#web-socket-api](https://github.com/dogetoreum/insight-api-dogetoreum#web-socket-api)
* API: [https://github.com/dogetoreum/insight-api-dogetoreum#instantsend-transactions](https://github.com/dogetoreum/insight-api-dogetoreum#instantsend-transactions)
