# Support for Output Descriptors in Dogetoreum Core

Since Dogetoreum Core v0.17 with Future Lock Transactions, 
...
existing Dogetoreum Core wallets, a convenience function `combo` is
...
All RPCs in Dogetoreum Core will include the checksum in their output. Only
