...
This document provides guidelines for internationalization of the Dogetoreum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dogetoreum_en.ts` remains unchanged.
