...
* dogetoreum.conf: contains configuration settings for dogetoreumd or dogetoreum-qt
* dogetoreumd.pid: stores the process id of dogetoreumd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by dogetoreumd or dogetoreum-qt
