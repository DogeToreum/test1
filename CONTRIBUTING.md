Contributing to Dogetoreum Core
============================

The Dogetoreum Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to dogetoreum-qt
...
[Translation Process](https://github.com/DogeToreum/dogetoreum/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Dogetoreum Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Dogetoreum
Network Protocol consensus changes.

Whether a pull request is merged into Dogetoreum Core rests with the project merge
...
Patches that change Dogetoreum consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dogetoreum consensus, it must have been
...
The review process is normally fairly responsive on the Dogetoreum Core repository, however
...
The project leader is the release manager for each Dogetoreum Core release.
