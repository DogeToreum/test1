...
rm -f src/config/dogetoreum-config.h
...
rm -rf test_bitcoin.coverage/ dogetoreum-gtest.coverage/ total.coverage/
...
clean_exe src/bench/bench_dogetoreum
clean_exe src/dogetoreum-cli
clean_exe src/dogetoreumd
clean_exe src/dogetoreum-gtest
clean_exe src/test/test_dogetoreum
clean_exe src/test/test_dogetoreum_fuzzy
clean_exe src/qt/dogetoreum-qt
clean_exe src/qt/test/test_dogetoreum-qt
...
clean_dep . src/config/dogetoreum-config.h.in
