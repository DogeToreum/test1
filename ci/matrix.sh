...
export BUILDER_IMAGE_NAME="dogetoreum-builder-$BUILD_TARGET-$JOB_NUMBER"
...
if [ "$BUILD_TARGET" = "arm-linux" ]; then
  ...
  export USE_SHELL="/bin/dogetoreum"
  export PYZMQ=true
  export RUN_UNITTESTS=true
  ...
  export CPPFLAGS="-DDEBUG_LOCKORDER -DENABLE_DOGETOREUM_DEBUG"
  export PYZMQ=true
  export RUN_UNITTESTS=true
  export RUN_INTEGRATIONTESTS=true
